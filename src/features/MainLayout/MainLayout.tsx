...
import { IPropertyServiceResponse } from 'src/shared/lib/pageData/propertyService/propertyService.interface'
...
export const MainLayout: FC<MainLayoutPropsInterface> = ({
  ...
  // useEffect(() => {
  //   const isEmail = router.query.action === 'check' || router.query.action === 'unsubscribe'
  //   const isEmailCheck = router.query.action === 'check'
  //   const isEmailUnsubscribe = router.query.action === 'unsubscribe'
  //
  //   if (!isEmail || !router.isReady) return
  //
  //   const hasUrlHash = router.asPath.includes('hash=')
  //   const hasUrlEmail = router.asPath.includes('email=')
  //   const urlHash = router.asPath.split(/\?/)[1]?.replace('hash=', '')?.split(/\&/)[0]
  ...
  //     router.push('/')
  //   }
  // }, [router.isReady, router.query.action, router.asPath, router.query.email, hash, email, modal])
  ...
  return (
    <div className="layout" id="mainLayout">
      ...
      {/*              {common.block_drop_menu.Links[0].title}*/}
      {/*            </div>*/}
      ...
      {/*          <div className="header-menu__col">*/}
      {/*            <div className="header-menu__title">*/}
      {/*              {common.block_drop_menu.Links[1].title}*/}
      {/*            </div>*/}
      ...
      {/*        <div className="header-menu__section">*/}
      {/*          <a*/}
      {/*            href={common.block_drop_menu.EmailLink.link}*/}
      {/*            className="header-menu__link"*/}
      {/*          >*/}
      {/*            <div className="header-menu__subtitle">*/}
      ...
      {/*        <div className="header-menu__section">*/}
      {/*          <a*/}
      {/*            href={common.block_drop_menu.TelegramLink.link}*/}
      {/*            className="header-menu__link"*/}
      {/*          >*/}
      {/*            <div className="header-menu__subtitle">*/}
      ...
      {/*            {common.block_footer.get_news.header_title}*/}
      {/*          </div>*/}

      {/*          <div className="footer__description">*/}
      {/*            {common.block_footer.get_news.text}*/}
      {/*          </div>*/}
      ...
      {/*        <div className="footer__header-i">*/}
      {/*          <div className="footer__title">*/}
      {/*            {common.block_footer.follow_us.title}*/}
      {/*          </div>*/}

      {/*          <div className="footer__description">*/}
      {/*            {common.block_footer.follow_us.text}*/}
      {/*          </div>*/}

      {/*          <div className="footer__button">*/}
      {/*            <Button*/}
      {/*              onClick={() =>*/}
      {/*                router.push(common.block_footer.follow_us.button.link)*/}
      {/*              }*/}
      {/*              s="large"*/}
      {/*              variant="whiteStroke"*/}
      ...
      {/*                  width={*/}
      {/*                    common.block_footer.col1.link[1]?.img?.data*/}
      {/*                      ?.attributes?.width*/}
      {/*                  }*/}
      {/*                  height={*/}
      {/*                    common.block_footer.col1.link[1]?.img?.data*/}
      ...
      {/*              {common.block_footer.col2.title}*/}
      {/*            </div>*/}
      ...
      {/*            <div className="footer__subtitle">*/}
      {/*              {common.block_footer.col3.title}*/}
      {/*            </div>*/}
      ...
      {/*            <div className="footer__subtitle">*/}
      {/*              {common.block_footer.col4.title}*/}
      {/*            </div>*/}
      ...
      {/*          <span>*/}
      {/*            г. Москва, ул. Нижняя Красносельская, д 35, стр. 9, лобби*/}
      {/*            2&emsp;*/}
      {/*          </span>*/}
      ...
      {/*{ propertyService && <PropertyServicesModal*/}
      {/*  isOpen={propertyService.propertyServiceState.isOpen}*/}
      {/*  emitIsOpen={(isOpen) => {propertyService.propertyServiceState.openProperty(isOpen)}}*/}
      ...
      {/*    email.action.subscribeEmail?.(form as { name: string; email: string });*/}
      {/*  }}*/}
      {/*/>*/}
      ...
      {/*    }*/}
      {/*  }}*/}
      {/*  emitSubmit={() => {modal.action.openFeedbackModal(EModalVariant.REQUEST_ACCEPTED)}}*/}
      {/*/>*/}
