...
import classes from 'src/features/commercialPage/AdvantagesAndSpeakers/AdvantagesAndSpeakers.module.scss'
import { IBlockAdvantages, IBlockSpeakers } from 'shared/services/pageData/office/office.interface'
    ...
    <section className={classes.blockList}>
      <div className={classes.blockList__item}>
        <div className={classes.teaserList}>
          ...
          <div
            className={
              classes.teaserList__item + ' ' + classes.teaserList__item_tabletS_hide
            }></div>
        </div>
      ...
      <div className={classes.blockList__item}>
        ...
        <div className={classes.teaserL}>
          <h2
            className={classes.teaserL__h}
            dangerouslySetInnerHTML={{ __html: speakers?.title }}
          />
