import { EFormType } from '../types/form.interface'
import { EModalVariant } from '../types/modal.interface'
import { IFormToEmit } from '../types/modal.interface'
import {
...
export const useLayoutModal = (isOpenCallbackModal: boolean) => {
  // TODO это переписать чтобы был независимым
